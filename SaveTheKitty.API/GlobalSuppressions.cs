...
[assembly: SuppressMessage("Mapper", "RMG020:Source member is not mapped to any target member", Justification = "<Pending>", Scope = "member", Target = "~M:SaveTheKitty.API.Contracts.Responses.GetCatsMapper.Map(SaveTheKitty.API.Entities.Cats.Cat)~SaveTheKitty.API.Contracts.Responses.CatResponse")]
